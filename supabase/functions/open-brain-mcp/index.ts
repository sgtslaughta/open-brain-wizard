 ...
 * Exposes search_thoughts, list_thoughts, thought_stats, capture_thought via MCP.
 */
...
server.registerTool(
  "capture_thought",
  {
    ...
    description:
      "Save a new thought to the open-brain-wizard. Generates an embedding and extracts metadata automatically.",
    inputSchema: {
